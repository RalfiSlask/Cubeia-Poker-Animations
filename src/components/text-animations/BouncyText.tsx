...
const BouncyText = () => {
  return (
    <motion.video
      className="uppercase absolute bottom-[75px] left-2 w-[900px] h-[200px] z-20 flex items-center justify-center"
    ...
    >
      <source src="/Cubeia-Poker-Animations/bouncy.webm" type="video/webm" />
