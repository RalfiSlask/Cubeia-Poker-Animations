...
const StarsParticles = () => {
  return (
    <motion.video
      className="uppercase absolute bottom-[15px] w-[900px] h-[200px]  z-20 flex items-center justify-center"
    ...
    >
      <source src="/Cubeia-Poker-Animations/starsparticles.webm" type="video/webm" />
