...
const FillingText = () => {
  return (
    <motion.video
      className="uppercase absolute bottom-[15px] w-[900px] h-[200px] right-2 z-20 flex items-center justify-center"
    ...
    >
      <source src="/Cubeia-Poker-Animations/fillingtext.webm" type="video/webm" />
