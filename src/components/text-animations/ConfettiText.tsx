...
const ConfettiText: React.FC<{ text: string }> = ({ text }) => {
  return (
    <motion.div
      className="eurostile text-5xl w-full  font-bold confetti-gradient uppercase absolute bottom-24 z-20 flex items-center justify-center"
