...
const ParticleAnimation = () => {
  return (
    <motion.video
      className="uppercase absolute bottom-20 w-[400px] h-[200px] z-20 flex items-center justify-center"
    ...
    >
      <source src="/Cubeia-Poker-Animations/particle.webm" type="video/webm" />
